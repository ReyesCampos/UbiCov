    ...
    <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <p class="card-text" id="seccion3" style="text-align: justify">
                  Nosotros creemos que el cuidar de la salud y bienestar de nuestros seres queridos es una prioridad. 
                </p>
                <p class="card-text" id="seccion3" style="text-align: justify">
            ...
            <div class="card col-lg-5 col-md-4 col-sm-12" style="width: 10rem;" >
                <img src="{{asset('/img/Slogan.png')}}" class="card-img-top" alt="...">
                <div class="card-body">
                    <p class="card-text" style="text-align: justify">
                    Asegura tu salud y la de tus seres queridos evitando visitar lugares de riesgo al contagiarse de COVID-19. 
                    Prueba nuestra app ahora.
                    </p>
                </div>
            </div>
            <div class="card col-lg col-md col-sm-12" style="width: 10rem;">
                <img src="{{asset('/img/itsncg.png')}}" class="card-img-top" alt="..." >
                 <div class="card-body">
                     ...
                     Miembros: Judith Cabral, Alejandra Muñoz, Aneth Ochoa, María Reyes, Luisa Sandoval.
                     </p>
                </div>
            </div>
